...
from app.models.user import User  # ✅ align with CRUD import
...
# ✅ Read by USERNAME — distinct path to avoid clash
...
# ✅ Read by ID — explicit 'id' segment
...
# ✅ Update by ID — explicit 'id' segment
@router.put("/id/{user_id}", response_model=dict)
...
# ✅ Delete by ID — explicit 'id' segment
